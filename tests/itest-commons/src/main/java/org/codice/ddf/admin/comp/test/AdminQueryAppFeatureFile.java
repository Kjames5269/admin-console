...
public class AdminQueryAppFeatureFile {
  ...
  public static Feature adminQuerySts() {
    return new FeatureImpl(ADMIN_QUERY_FEATURE.getFeatureFileUrl(), ADMIN_QUERY_STS);
  }
  ...
  public static Feature adminQueryLdap() {
    return new FeatureImpl(ADMIN_QUERY_FEATURE.getFeatureFileUrl(), ADMIN_QUERY_LDAP);
  }

  public static Feature adminQueryEmbeddedLdapq() {
    return new FeatureImpl(ADMIN_QUERY_FEATURE.getFeatureFileUrl(), ADMIN_QUERY_EMBEDDED_LDAP);
  }

  public static Feature adminQuerySources() {
    return new FeatureImpl(ADMIN_QUERY_FEATURE.getFeatureFileUrl(), ADMIN_QUERY_SOURCES);
  }
